  ...
  Formbuilder = (function() {
    ...
    Formbuilder.helpers = {
      defaultFieldAttrs: function(type) {
        ...
        attrs = {};
        if (type === "innerform") {
          attrs[Formbuilder.options.mappings.LABEL] = 'Inner Form';
        } else {
    ...
    Formbuilder.options = {
      ...
      ENABLED_FIELDS: ['text', 'checkbox', 'dropdown', 'textarea', 'radio', 'date', 'number', 'time', 'email', 'file', 'image', 'section', 'cnic', 'serialnumber', 'grid', 'innerform'],
      mappings: {
        REPEATABLE: 'repeatable',
        INNERFORM_NAME: 'innerform_name',
        SIZE: 'options.size',
        PIN: 'options.pin',
...
(function() {
  Formbuilder.registerField('cnic', {
    ...
    addButton: "<span class=\"fa fa-vcard\"></span> CNIC"
  });
...
(function() {
  Formbuilder.registerField('recievepin', {
    ...
    edit: "<%= Formbuilder.templates['edit/pinrequired']() %>",
    addButton: "<span class=\"fa fa-check\"></span> Recieve Pin"
  });
...
(function() {
  Formbuilder.registerField('innerform', {
    ...
    edit: "<%= Formbuilder.templates['edit/innerform_name']() %>",
    addButton: "<span class=\"\"><small><b>---</b></small></span> Inner Form"
  });
...
(function() {
  Formbuilder.registerField('serialnumber', {
    ...
    view: "<% var initial_value = rf.get(Formbuilder.options.mappings.INITIAL_VALUE); %>\n<input type='text' value='<%= initial_value %>' class='rf-size-<%= rf.get(Formbuilder.options.mappings.SIZE) %>' />",
    edit: "",
    addButton: "<span class=\"fa fa-vcard\"></span> Serial Number"
  });
...
this["Formbuilder"]["templates"]["edit/innerform_name"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'fb-edit-section-header\'>Inner Form Name</div>\r\n<input type=\'text\' data-rv-input=\'model.' +
((__t = ( Formbuilder.options.mappings.INNERFORM_NAME )) == null ? '' : __t) +
'\' />';
...
this["Formbuilder"]["templates"]["edit/pinrequired"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<input type=\'checkbox\' class="number_for_pin" data-rv-checked=\'model.' +
((__t = ( Formbuilder.options.mappings.PIN )) == null ? '' : __t) +
'\' /> PIN Required <br>';
...
this["Formbuilder"]["templates"]["view/pin"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape, __j = Array.prototype.join;
function print() { __p += __j.call(arguments, '') }
with (obj) {

 if (rf.get(Formbuilder.options.mappings.PIN)) { ;
__p += '\r\n<div class="pin_div">\r\n  <span class="pin_label">PIN<br />\r\n    <input type=\'text\' class="pinnumber"/>\r\n</div>\r\n';
 } ;
__p += '\r\n';
